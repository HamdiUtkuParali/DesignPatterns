...
namespace Visitor
{
    ...
    class PayrollVisitor : VisitorBase
    {
        ...
        {
            Console.WriteLine("{0} paid to {1}", worker.Salary, worker.Name);
        }

        public override void Visit(Manager manager)
        {
            Console.WriteLine("{0} paid to {1}", manager.Salary, manager.Name);
        }
    }
    ...
    class PayriseVisitor : VisitorBase
    {
        ...
        public override void Visit(Manager manager)
        {
            Console.WriteLine("{0}'s salary increased to {1}", manager.Name, manager.Salary * (decimal)1.2);
        }
    }
